...
/// </summary>
public class GoodsReceiptModuleTests : M2IntegrationTestBase, IClassFixture<TestWebApplicationFactory>
{
    public GoodsReceiptModuleTests(TestWebApplicationFactory factory) : base(factory) { }
