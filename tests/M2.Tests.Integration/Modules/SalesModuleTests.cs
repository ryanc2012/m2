...
/// </summary>
public class SalesModuleTests : M2PlatformIntegrationTestBase, IClassFixture<PlatformWebApplicationFactory>
{
    public SalesModuleTests(PlatformWebApplicationFactory factory) : base(factory) { }
